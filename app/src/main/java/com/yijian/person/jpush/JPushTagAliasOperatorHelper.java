...
public class JPushTagAliasOperatorHelper {
    private static final String TAG = "JPushTagAliasOperatorHelper";
    ...
    public void onAliasOperatorResult(Context context, JPushMessage jPushMessage) {
        ...
        Logger.i(TAG, "action - onAliasOperatorResult, sequence:" + sequence + ",alias:" + alias);

        if (!SharePreferenceUtil.hasJpushAlias()) {
            if (alias != null && !TextUtils.isEmpty(alias) && !alias.equals("null")) {
                SharePreferenceUtil.setJpushAlias(alias);
            }
        }
    ...
    public static class TagAliasBean {
        ...
        public String alias;
        public boolean isAliasAction;//true 设置别名，false 设置标签


        public TagAliasBean(int action, String alias, boolean isAliasAction) {
            this.action = action;
            this.alias = alias;
